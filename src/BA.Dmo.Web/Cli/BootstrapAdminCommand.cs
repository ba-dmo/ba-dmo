...
public static class BootstrapAdminCommand
{
        ...
        TextWriter stderr)
    {
        ...
        // 3. One-shot operation. The provisioning adapter is constructed
        //    HERE — it never exists in the web request pipeline.
        ...
        try
        {
            ...
            if (result.IsSuccess)
            {
                stdout.WriteLine(result.Value == BootstrapAdminOutcome.AlreadyExists
