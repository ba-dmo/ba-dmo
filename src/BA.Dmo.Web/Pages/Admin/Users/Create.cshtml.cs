...
public class CreateModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(
        string email, string password, string displayName, string? profileTitle, string templateId)
    {
        Templates = await _templates.ListAsync(HttpContext.RequestAborted);
        ...
        var result = await _users.CreateUserAsync(
            new CreateAdminUserRequest(email, password, displayName, profileTitle, templateId),
